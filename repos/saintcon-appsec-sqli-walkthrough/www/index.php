...
<div style="display:flex;">
	...
	<div style="">
		<div style="background-color:#3d3d4d; color:white; max-width: 500px; margin-right:100px; padding: 10px;" class="rounded">
			<h2>Instructions</h2>
			<p>Remember <a href="https://xkcd.com/327/" target="_blank" style="color:#ddddff">Bobby Tables</a>? Yeah, not here. This page will walk you through fixing the classic SQL injection in a login page.</p>
			<p>Instructions</p>
			<ol>
